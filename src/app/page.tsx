...
export default async function Home({searchParams :{page="1"}}:HomeProps) {
 ...
 <div className='hero rounded-xl bg-base-300'>
  ...
  <Image  src={products[0].imageUrl} alt={products[0].name} width={400} height={800} className='w-full max-w-sm rounded-lg shadow-lg ' priority/>
  <div><h1 className='text-5xl font-bold '>{products[0].name}</h1>
